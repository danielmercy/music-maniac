...
class _AccountRolesState extends State<AccountRoles> { 
  ...
  void initState() {
    super.initState();
    roles.add(AccountRoleModel(false, "Sponsor", "Lorem ipsim dit amor sit amorir"));
    roles.add(AccountRoleModel(false, "Fan", "Lorem ipsim dit amor sit amorir"));
    roles.add(AccountRoleModel(false, "Artist", "Lorem ipsim dit amor sit amorir"));
  }
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Padding(
            padding: index != 0 ? EdgeInsets.only(right: 20, top: 8) : EdgeInsets.only(right: 20, left: 20, top: 8),
            child: InkWell(
              onTap: () {
                setState(() {
                ...
                widget.onPress(roles[index].toMap());
              },
              child: AccountRoleItem(
                roles[index]
              ),
            ),
          );
